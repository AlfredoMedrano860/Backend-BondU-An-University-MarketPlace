...
router.post("/", authenticateToken, validateBody(createUserStatsSchema), createUserStats);
router.put("/:id", authenticateToken, validateParams(idSchema), validateBody(updateUserStatsSchema), updateUserStats);
router.delete("/:id", authenticateToken, validateParams(idSchema), deleteUserStats);
